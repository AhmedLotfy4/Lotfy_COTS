...
/*Configure the MCU pins directions , options :
												1- INPUT
												2- OUTPUT */
...
/*CONFIGURE MCU PINS INITIAL VALUE IN CASE OF INPUT DIRECTION, OPTIONS : 1- FLOATING 
																		 2-PULLED_UP
									INCASE OF OUTPUT DIRECTIONS< OPTIONS : 1-LOW*
																		   2-HIGH*/
